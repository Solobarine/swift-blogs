...
ActiveRecord::Schema[7.0].define(version: 20_230_125_174_924) do
  ...
  create_table 'posts', force: :cascade do |t|
    t.integer 'aurhor_id_id', null: false
    t.string 'title'
    t.text 'text'
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['aurhor_id_id'], name: 'index_posts_on_aurhor_id_id'
  end
  ...
  add_foreign_key 'posts', 'aurhor_ids'
end
